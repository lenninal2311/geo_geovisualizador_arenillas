...
function exp_Zona_de_riesgo_7rule0_eval_expression(context) {
    // cota_msnm <= 4.5

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('cota_msnm')  <= 4.5);
    } else {
        return (feature.get('cota_msnm')  <= 4.5);
    }
}
...
function exp_Zona_de_riesgo_7rule1_eval_expression(context) {
    // cota_msnm > 4.5 AND cota_msnm <= 5.5

    var feature = context.feature;
    
    if (feature.properties) {
        return ((feature.get('cota_msnm')  > 4.5) && (feature.get('cota_msnm')  <= 5.5));
    } else {
        return ((feature.get('cota_msnm')  > 4.5) && (feature.get('cota_msnm')  <= 5.5));
    }
}
...
function exp_Zona_de_riesgo_7rule2_eval_expression(context) {
    // cota_msnm > 5.5

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('cota_msnm')  > 5.5);
    } else {
        return (feature.get('cota_msnm')  > 5.5);
    }
}