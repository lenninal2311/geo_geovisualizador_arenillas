...
var format_equipamientos_8 = new ol.format.GeoJSON();
var features_equipamientos_8 = format_equipamientos_8.readFeatures(json_equipamientos_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_equipamientos_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_equipamientos_8.addFeatures(features_equipamientos_8);
var lyr_equipamientos_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_equipamientos_8, 
                style: style_equipamientos_8,
                popuplayertitle: 'equipamientos',
                interactive: true,
                title: '<img src="styles/legend/equipamientos_8.png" /> equipamientos'
            });
var format_Accesibilidad_educativa_300m_9 = new ol.format.GeoJSON();
var features_Accesibilidad_educativa_300m_9 = format_Accesibilidad_educativa_300m_9.readFeatures(json_Accesibilidad_educativa_300m_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Accesibilidad_educativa_300m_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Accesibilidad_educativa_300m_9.addFeatures(features_Accesibilidad_educativa_300m_9);
var lyr_Accesibilidad_educativa_300m_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Accesibilidad_educativa_300m_9, 
                style: style_Accesibilidad_educativa_300m_9,
                popuplayertitle: 'Accesibilidad_educativa_300m',
                interactive: true,
                title: '<img src="styles/legend/Accesibilidad_educativa_300m_9.png" /> Accesibilidad_educativa_300m'
            });
var format_Accesibilidad_salud_600m_10 = new ol.format.GeoJSON();
var features_Accesibilidad_salud_600m_10 = format_Accesibilidad_salud_600m_10.readFeatures(json_Accesibilidad_salud_600m_10, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Accesibilidad_salud_600m_10 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Accesibilidad_salud_600m_10.addFeatures(features_Accesibilidad_salud_600m_10);
var lyr_Accesibilidad_salud_600m_10 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_Accesibilidad_salud_600m_10, 
                style: style_Accesibilidad_salud_600m_10,
                popuplayertitle: 'Accesibilidad_salud_600m',
                interactive: true,
                title: '<img src="styles/legend/Accesibilidad_salud_600m_10.png" /> Accesibilidad_salud_600m'
            });
var format_area_verde_11 = new ol.format.GeoJSON();
var features_area_verde_11 = format_area_verde_11.readFeatures(json_area_verde_11, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_area_verde_11 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_area_verde_11.addFeatures(features_area_verde_11);
var lyr_area_verde_11 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_area_verde_11, 
                style: style_area_verde_11,
                popuplayertitle: 'area_verde',
                interactive: true,
                title: '<img src="styles/legend/area_verde_11.png" /> area_verde'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_Area_de_estudio_1.setVisible(false);lyr_parcelas_2.setVisible(true);lyr_lotes_urbanos_3.setVisible(true);lyr_Manzanas_4.setVisible(false);lyr_red_vial_5.setVisible(true);lyr_hidrografia_6.setVisible(true);lyr_Zona_de_riesgo_7.setVisible(false);lyr_equipamientos_8.setVisible(true);lyr_Accesibilidad_educativa_300m_9.setVisible(false);lyr_Accesibilidad_salud_600m_10.setVisible(false);lyr_area_verde_11.setVisible(false);
var layersList = [lyr_OpenStreetMap_0,lyr_Area_de_estudio_1,lyr_parcelas_2,lyr_lotes_urbanos_3,lyr_Manzanas_4,lyr_red_vial_5,lyr_hidrografia_6,lyr_Zona_de_riesgo_7,lyr_equipamientos_8,lyr_Accesibilidad_educativa_300m_9,lyr_Accesibilidad_salud_600m_10,lyr_area_verde_11];
...
lyr_equipamientos_8.set('fieldAliases', {'fid': 'fid', 'nombre': 'nombre', 'tipo': 'tipo', 'capacidad': 'capacidad', });
lyr_Accesibilidad_educativa_300m_9.set('fieldAliases', {'fid': 'fid', 'nombre': 'nombre', 'tipo': 'tipo', 'capacidad': 'capacidad', });
lyr_Accesibilidad_salud_600m_10.set('fieldAliases', {'fid': 'fid', 'nombre': 'nombre', 'tipo': 'tipo', 'capacidad': 'capacidad', });
lyr_area_verde_11.set('fieldAliases', {'fid': 'fid', 'nombre': 'nombre', 'tipo': 'tipo', 'area_m2': 'area_m2', });
...
lyr_equipamientos_8.set('fieldImages', {'fid': 'TextEdit', 'nombre': 'TextEdit', 'tipo': 'TextEdit', 'capacidad': 'Range', });
lyr_Accesibilidad_educativa_300m_9.set('fieldImages', {'fid': 'TextEdit', 'nombre': 'TextEdit', 'tipo': 'TextEdit', 'capacidad': 'Range', });
lyr_Accesibilidad_salud_600m_10.set('fieldImages', {'fid': 'TextEdit', 'nombre': 'TextEdit', 'tipo': 'TextEdit', 'capacidad': 'Range', });
lyr_area_verde_11.set('fieldImages', {'fid': 'TextEdit', 'nombre': 'TextEdit', 'tipo': 'TextEdit', 'area_m2': 'TextEdit', });
...
lyr_equipamientos_8.set('fieldLabels', {'fid': 'inline label - visible with data', 'nombre': 'inline label - visible with data', 'tipo': 'inline label - visible with data', 'capacidad': 'inline label - visible with data', });
lyr_Accesibilidad_educativa_300m_9.set('fieldLabels', {'fid': 'inline label - visible with data', 'nombre': 'inline label - visible with data', 'tipo': 'inline label - visible with data', 'capacidad': 'inline label - visible with data', });
lyr_Accesibilidad_salud_600m_10.set('fieldLabels', {'fid': 'inline label - visible with data', 'nombre': 'inline label - visible with data', 'tipo': 'inline label - visible with data', 'capacidad': 'inline label - visible with data', });
lyr_area_verde_11.set('fieldLabels', {'fid': 'inline label - visible with data', 'nombre': 'inline label - visible with data', 'tipo': 'inline label - visible with data', 'area_m2': 'inline label - visible with data', });
lyr_area_verde_11.on('precompose', function(evt) {
